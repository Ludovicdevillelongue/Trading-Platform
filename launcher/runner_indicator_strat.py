...
if __name__ == '__main__':
    ...
    param_grids = {
        ...
        'RSI': {'RSI_period': (5, 15), 'overbought_threshold': (65, 75), 'oversold_threshold': (25, 35)},
        'MOM': {'momentum': (5, 15)},
        'MeanRev': {'sma': (5, 20), 'threshold': (0.01, 0.1)},
        'Turtle': {'window_size': (10, 30)},
        'ParabolicSAR': {'SAR_step': (0.01, 0.1), 'SAR_max': (0.1, 0.4)},
