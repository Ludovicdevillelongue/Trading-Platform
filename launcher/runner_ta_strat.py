...
if __name__ == '__main__':
    ...
    strat_type = float(strat_type_yaml['strat_position']['long_short'])
    ...
    strat_run = LiveStrategyRunner(best_strat, strategies[best_strat], strat_type, optimization_results, frequency_yaml, frequency, symbol,
